...
//  SearchTextField
// Created by ION on 11/9/17.
// Copyright :copyright: 2017 CMN. All rights reserved.
...
open class SearchTextField: UITextField {
    ...
    override open func willMove(toSuperview newSuperview: UIView?) {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(SearchTextField.keyboardWillShow(_:)),
            name: UIResponder.keyboardWillShowNotification, object: nil)
        NotificationCenter.default.addObserver(self, selector: #selector(SearchTextField.keyboardWillHide(_:)),
            name: UIResponder.keyboardWillHideNotification, object: nil)
        NotificationCenter.default.addObserver(self, selector: #selector(SearchTextField.keyboardDidChangeFrame(_:)),
